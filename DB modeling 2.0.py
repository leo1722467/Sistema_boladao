...
# ============================================================
# Convenções + Mixin de timestamps
# ============================================================
...
Base.metadata.naming_convention = convention  # usa as convenções acima
...
class AuditLog(Base):
    """
    Tabela 'logs' para auditoria do sistema.
    """
    __tablename__ = "logs"
    ...
    acao: Mapped[str] = mapped_column(Text, nullable=False)                 # INSERT, UPDATE, DELETE, LOGIN...
...
class Ativo(Base):
    ...
    estoque_item = relationship("Estoque", back_populates="ativo", uselist=False)
...
class OrdemServico(Base):
    ...
    chamado = relationship("Chamado", back_populates="ordens_servico")
...
class Estoque(Base):
    ...
    ativo = relationship("Ativo", back_populates="estoque_item")
...
class Chamado(Base):
    ...
    # Requisitante / agente / proprietário -> usam 'contato'
    ...
    ordens_servico = relationship("OrdemServico", back_populates="chamado")
